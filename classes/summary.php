...
//        $usersummary->percentagesessionscompleted = format_float($usersummary->takensessionspercentage * 100) . '%';
        ...
        if ($user_log[0]['count'] > 0) {
            $usersummary->numtakensessions = $user_log[0]['count'];
            $usersummary->takensessionspoints = $user_log[0]['c']*2 + $user_log[0]['b']*2 + $user_log[0]['t'];
            $usersummary->takensessionsmaxpoints = $user_log[0]['count']*2;
        } else {
            $usersummary->numtakensessions = 0;
            $usersummary->takensessionspoints = 0;
            $usersummary->takensessionsmaxpoints = 0;
